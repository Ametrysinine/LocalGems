...
const MapContainer = (props) => {
  const DisplayedGems = props.gems?.map(gem => <MapGem key={gem._id} location={gem.location} description={gem.description} type={gem.type} name={gem.name} images={gem.images}>
    </MapGem>)
